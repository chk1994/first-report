...
There are also alternatives to emply AES besides using Java. A possible alternative is the use of PHP which may potentially help with linking to our front-end server. An example is shown [here](https://aesencryption.net/).
